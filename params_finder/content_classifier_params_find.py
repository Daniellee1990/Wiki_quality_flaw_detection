...
# model
def Bidirectional_LSTM_best(X_train_content, y_train, learning_rate, dropout_rate, adam_decay):
...
def Bidirectional_RNN_sematic(X_train_content, y_train, learning_rate, dropout_rate, adam_decay):
    X_train = X_train_content
    hidden_rnn_dim = 64
    content_input = Input(shape=(X_train.shape[1],X_train.shape[2]), name='bert_sent_encoded_input')
...
def Bidirectional_GRU_sematic(X_train_content, y_train, learning_rate, dropout_rate, adam_decay):
    X_train = X_train_content
    hidden_gru_dim = 64
    content_input = Input(shape=(X_train.shape[1],X_train.shape[2]), name='bert_sent_encoded_input')
...
def fitness(learning_rate, dropout_rate,
    ...
    model = Bidirectional_RNN_sematic(
                         X_train_content=X_train,
                         y_train=y_train,
