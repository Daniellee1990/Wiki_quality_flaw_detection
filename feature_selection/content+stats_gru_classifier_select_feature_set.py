...
if __name__ == '__main__':
    ...
    for flaw_index in range(6):
        ...
        # 在每个flaw下分别计算指标
        for feature_index in range(4, 5):
            feature_set = [[0, 13], [13, 23], [23, 43], [43, 50], [50, 65]]
            X_train_stats_one_set = X_train_stats[:, feature_set[feature_index][0] : feature_set[feature_index][1]]
            # 引入十折交叉验证
            ...
            for train, test in kfold.split(X_train_content, y_train):
                ...
                X_test_content_kfold, X_test_stats_kfold, y_test_kfold = X_train_content[test], X_train_stats_one_set[test], y_train[test]
                X_val_content_kfold, X_val_stats_kfold, y_val_kfold = X_train_content[train[-1000:]], X_train_stats_one_set[train[-1000:]], y_train[train[-1000:]]
                X_train_content_kfold, X_train_stats_kfold, y_train_kfold = X_train_content[train[:-1000]], X_train_stats_one_set[train[:-1000]], y_train[train[:-1000]]
